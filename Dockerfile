...
# Merge CookieRTMP (security enhancements) into the standard module
COPY CookieRTMP/ /tmp/build/nginx-rtmp-module/nginx-rtmp-module-${NGINX_RTMP_MODULE_VERSION}/
